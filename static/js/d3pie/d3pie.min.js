    ...
    var a = "d3pie",
        ...
        d = {
            header: {
                ...
                subtitle: { text: "", color: "#666666", fontSize: 14, font: "arial" },
                location: "top-center",
                titleSubtitlePadding: 8
            },
            footer: { text: "", color: "#666666", fontSize: 14, font: "arial", location: "left" },
            size: {
                canvasHeight: 500,
                canvasWidth: 500,
                pieInnerRadius: "0%",
            ...
            data: {
                sortOrder: "none",
                ignoreSmallSegments: { enabled: !1, valueType: "percentage", value: null },
            ...
            labels: {
                outer: { format: "label", hideWhenLessThanPercentage: null, pieDistance: 30 },
                inner: { format: "percentage", hideWhenLessThanPercentage: null },
                mainLabel: { color: "#333333", font: "arial", fontSize: 10 },
                percentage: { color: "#dddddd", font: "arial", fontSize: 10, decimalPlaces: 0 },
                value: { color: "#cccc44", font: "arial", fontSize: 10 },
                lines: { enabled: !0, style: "curved", color: "segment" },
                truncation: { enabled: !1, truncateLength: 30 },
                formatter: null
            },
            effects: {
                load: { effect: "default", speed: 1e3 },
                pullOutSegmentOnClick: { effect: "bounce", speed: 300, size: 10 },
            ...
            misc: {
                ...
                gradient: { enabled: !1, percentage: 95, color: "#000000" },
                canvasPadding: { top: 5, right: 5, bottom: 5, left: 5 },
                pieCenterOffset: { x: 0, y: 0 },
                cssPrefix: null
            },
            callbacks: {
                onload: null,
        ...
        e = {
            initialCheck: function(a) {
                ...
                for (var e = [], g = 0; g < d.data.content.length; g++)
                    "number" != typeof d.data.content[g].value || isNaN(d.data.content[g].value)
                        ? console.log("not valid: ", d.data.content[g])
                        : d.data.content[g].value <= 0
                            ? console.log(
                                  "not valid - should have positive value: ",
                                  d.data.content[g]
                              )
                            : e.push(d.data.content[g]);
        ...
        f = {
            addSVGSpace: function(a) {
                ...
                return (
                    "transparent" !== e &&
                        f.style("background-color", function() {
                            return e;
                        }),
                    f
                );
            ...
            whenIdExists: function(a, b) {
                var c = 1,
                    ...
                    e = setInterval(function() {
                        document.getElementById(a) && (clearInterval(e), b()),
                            c > d && clearInterval(e),
                            c++;
                    }, 1);
            },
            ...
            processObj: function(a, b, c) {
                return "string" == typeof b
                    ? f.processObj(a, b.split("."), c)
                    : 1 === b.length && void 0 !== c
                        ? ((a[b[0]] = c), a[b[0]])
                        : 0 === b.length
                            ? a
                            : f.processObj(a[b[0]], b.slice(1), c);
            },
            ...
            initSegmentColors: function(a) {
                for (
                    var b = a.options.data.content,
                        c = a.options.misc.colors.segments,
                        d = [],
                        e = 0;
                    e < b.length;
                    e++
        ...
        g = function() {
                ...
                o = {
                    ...
                    isPlainObject: function(a) {
                        ...
                        try {
                            if (
                                a.constructor &&
                                !m.call(a, "constructor") &&
                                !m.call(a.constructor.prototype, "isPrototypeOf")
                            )
                                return !1;
                        } catch (b) {
                            return !1;
            ...
            for (
                "boolean" == typeof h && ((k = h), (h = arguments[1] || {}), (i = 2)),
                    "object" == typeof h || o.isFunction(h) || (h = {}),
                    j === i && ((h = this), --i),
                    i;
                j > i;
                i++
                ...
                if (null !== (a = arguments[i]))
                    for (b in a)
                        (c = h[b]),
                            (d = a[b]),
                            h !== d &&
                                (k && d && (o.isPlainObject(d) || (e = o.isArray(d)))
                                    ? (e
        ...
        h = {
            ...
            computePieRadius: function(a) {
                ...
                /%/.test(b.pieInnerRadius)
                    ? ((g = parseInt(b.pieInnerRadius.replace(/[\D]/, ""), 10)),
                      (g = g > 99 ? 99 : g),
                      (g = 0 > g ? 0 : g),
                      (f = Math.floor(h / 100 * g)))
                    : (f = parseInt(b.pieInnerRadius, 10)),
                    (a.innerRadius = f),
                    (a.outerRadius = h);
            },
            ...
            calculatePieCenter: function(a) {
                var b = a.options.misc.pieCenterOffset,
                    ...
                    d =
                        a.textComponents.subtitle.exists &&
                        "pie-center" !== a.options.header.location,
                    e = a.options.misc.canvasPadding.top;
                c && d
                    ? (e +=
                          a.textComponents.title.h +
                          a.options.header.titleSubtitlePadding +
                          a.textComponents.subtitle.h)
                    : c
                        ? (e += a.textComponents.title.h)
                        : d && (e += a.textComponents.subtitle.h);
                var f = 0;
                a.textComponents.footer.exists &&
                    (f = a.textComponents.footer.h + a.options.misc.canvasPadding.bottom);
                var g =
                        (a.options.size.canvasWidth -
                            a.options.misc.canvasPadding.left -
                            a.options.misc.canvasPadding.right) /
                            2 +
                        a.options.misc.canvasPadding.left,
                    h = (a.options.size.canvasHeight - f - e) / 2 + e;
                (g += b.x), (h += b.y), (a.pieCenter = { x: g, y: h });
            },
            ...
            translate: function(a, b, c, d) {
                var e = h.toRadians(d);
                return { x: a + c * Math.sin(e), y: b - c * Math.cos(e) };
            },
            pointIsInArc: function(a, b, c) {
                ...
                return (
                    (i = 0 > i ? i + 2 * Math.PI : i), h >= d * d && e * e >= h && i >= f && g >= i
                );
            }
        },
        i = {
            add: function(a, b, c) {
                var d = i.getIncludes(c),
                    e = a.options.labels,
                    f = a.svg
                        .insert("g", "." + a.cssPrefix + "labels-" + b)
                        .attr("class", a.cssPrefix + "labels-" + b),
                    g = f
                        .selectAll("." + a.cssPrefix + "labelGroup-" + b)
                        .data(a.options.data.content)
                        .enter()
                        .append("g")
                        .attr("id", function(c, d) {
                            return a.cssPrefix + "labelGroup" + d + "-" + b;
                        })
                        .attr("data-index", function(a, b) {
                            return b;
                        })
                        .attr("class", a.cssPrefix + "labelGroup-" + b)
                        .style("opacity", 0),
                    h = { section: b, sectionDisplayType: c };
                d.mainLabel &&
                    g
                        .append("text")
                        .attr("id", function(c, d) {
                        ...
                        .attr("class", a.cssPrefix + "segmentMainLabel-" + b)
                        .text(function(a, b) {
                            var c = a.label;
                            return (
                                e.formatter
                                    ? ((h.index = b),
                                      ...
                                      (h.label = c),
                                      (c = e.formatter(h)))
                                    : e.truncation.enabled &&
                                      a.label.length > e.truncation.truncateLength &&
                                      (c =
                                          a.label.substring(0, e.truncation.truncateLength) +
                                          "..."),
                                c
                            );
                        })
                        .style("font-size", e.mainLabel.fontSize + "px")
                        .style("font-family", e.mainLabel.font)
                        .style("fill", e.mainLabel.color),
                    d.percentage &&
                        g
                            .append("text")
                            .attr("id", function(c, d) {
                            ...
                            .attr("class", a.cssPrefix + "segmentPercentage-" + b)
                            .text(function(a, b) {
                                var c = a.percentage;
                                return (
                                    e.formatter
                            ...
                            .style("font-size", e.percentage.fontSize + "px")
                            .style("font-family", e.percentage.font)
                            .style("fill", e.percentage.color),
                    d.value &&
                        g
                            .append("text")
                            .attr("id", function(c, d) {
                            ...
                            .attr("class", a.cssPrefix + "segmentValue-" + b)
                            .text(function(a, b) {
                                return (
                                    (h.index = b),
                                    (h.part = "value"),
                            ...
                            .style("font-size", e.value.fontSize + "px")
                            .style("font-family", e.value.font)
                            .style("fill", e.value.color);
            },
            positionLabelElements: function(a, b, c) {
                ...
                switch (c) {
                    case "label-value1":
                        d3
                            .selectAll("." + a.cssPrefix + "segmentValue-" + b)
                            .attr("dx", function(a, b) {
                    ...
                    case "label-percentage1":
                        d3
                            .selectAll("." + a.cssPrefix + "segmentPercentage-" + b)
                            .attr("dx", function(a, b) {
                                return f[b].mainLabel.width + e;
                            });
                        break;
            ...
            computeLinePosition: function(a, b) {
                var c,
                    ...
                    e,
                    f,
                    g = j.getSegmentAngle(b, a.options.data.content, a.totalSize, { midpoint: !0 }),
                    i = h.rotate(
                        a.pieCenter.x,
                        a.pieCenter.y - a.outerRadius,
                        a.pieCenter.x,
                        a.pieCenter.y,
                        g
                    ),
                ...
                switch ((2 === m && 180 === g && (m = 1), m)) {
                    case 0:
                        (c =
                            a.outerLabelGroupData[b].x -
                            l -
                            (a.outerLabelGroupData[b].x - l - i.x) / 2),
                            (d =
                                a.outerLabelGroupData[b].y +
                                (i.y - a.outerLabelGroupData[b].y) / n),
                            (e = a.outerLabelGroupData[b].x - l),
                            (f = a.outerLabelGroupData[b].y - k);
                        break;
                    case 1:
                        (c = i.x + (a.outerLabelGroupData[b].x - i.x) / n),
                            (d = i.y + (a.outerLabelGroupData[b].y - i.y) / n),
                            (e = a.outerLabelGroupData[b].x - l),
                            (f = a.outerLabelGroupData[b].y - k);
                        break;
                    case 2:
                ...
                "straight" === a.options.labels.lines.style
                    ? (a.lineCoordGroups[b] = [{ x: i.x, y: i.y }, { x: e, y: f }])
                    : (a.lineCoordGroups[b] = [{ x: i.x, y: i.y }, { x: c, y: d }, { x: e, y: f }]);
            },
            addLabelLines: function(a) {
                var b = a.svg
                        .insert("g", "." + a.cssPrefix + "pieChart")
                        .attr("class", a.cssPrefix + "lineGroups")
                        .style("opacity", 0),
                    c = b
                        .selectAll("." + a.cssPrefix + "lineGroup")
                        .data(a.lineCoordGroups)
                        .enter()
                        .append("g")
                        .attr("class", a.cssPrefix + "lineGroup"),
                    d = d3
                        .line()
                        .curve(d3.curveBasis)
                        .x(function(a) {
                ...
                c
                    .append("path")
                    .attr("d", d)
                    .attr("stroke", function(b, c) {
                        return "segment" === a.options.labels.lines.color
                            ? a.options.colors[c]
                            : a.options.labels.lines.color;
                    })
                    .attr("stroke-width", 1)
                    .attr("fill", "none")
                    .style("opacity", function(b, c) {
                        var d = a.options.labels.outer.hideWhenLessThanPercentage,
                            e =
                                (null !== d && a.options.data.content[c].percentage < d) ||
                                "" === a.options.data.content[c].label;
                        return e ? 0 : 1;
                    });
            },
            positionLabelGroups: function(a, b) {
                "none" !== a.options.labels[b].format &&
                    d3
                        .selectAll("." + a.cssPrefix + "labelGroup-" + b)
                        .style("opacity", 0)
                        .attr("transform", function(c, d) {
                            var e, i;
                            if ("outer" === b)
                                (e = a.outerLabelGroupData[d].x), (i = a.outerLabelGroupData[d].y);
                            else {
                                var k = g(!0, {}, a.pieCenter);
                                if (a.innerRadius > 0) {
                                    var l = j.getSegmentAngle(
                                            d,
                                            a.options.data.content,
                                            a.totalSize,
                                            { midpoint: !0 }
                                        ),
                                        m = h.translate(
                                ...
                                var n = f.getDimensions(a.cssPrefix + "labelGroup" + d + "-inner"),
                                    o = n.w / 2,
                                    p = n.h / 4;
                                (e = k.x + (a.lineCoordGroups[d][0].x - k.x) / 1.8),
                                    (i = k.y + (a.lineCoordGroups[d][0].y - k.y) / 1.8),
                                    (e -= o),
                                    (i += p);
                            }
            ...
            fadeInLabelsAndLines: function(a) {
                var b =
                    "default" === a.options.effects.load.effect ? a.options.effects.load.speed : 1;
                setTimeout(function() {
                    var b = "default" === a.options.effects.load.effect ? 400 : 1;
                    d3
                        .selectAll("." + a.cssPrefix + "labelGroup-outer")
                        .transition()
                        .duration(b)
                        .style("opacity", function(b, c) {
                            var d = a.options.labels.outer.hideWhenLessThanPercentage;
                        ...
                        d3
                            .selectAll("." + a.cssPrefix + "labelGroup-inner")
                            .transition()
                            .duration(b)
                            .style("opacity", function(b, c) {
                        ...
                        d3
                            .selectAll("g." + a.cssPrefix + "lineGroups")
                            .transition()
                            .duration(b)
                            .style("opacity", 1),
                        f.isFunction(a.options.callbacks.onload) &&
                            setTimeout(function() {
                                try {
            ...
            getIncludes: function(a) {
                ...
                return { mainLabel: b, value: c, percentage: d };
            },
            ...
            resolveOuterLabelCollisions: function(a) {
                if ("none" !== a.options.labels.outer.format) {
                    ...
                    i.checkConflict(a, 0, "clockwise", b),
                        i.checkConflict(a, b - 1, "anticlockwise", b);
                }
            },
            checkConflict: function(a, b, c, d) {
                ...
                if (!(1 >= d)) {
                    ...
                    if (
                        !(
                            ("clockwise" === c && "right" !== h) ||
                            ("anticlockwise" === c && "left" !== h)
                        )
                    ) {
                        var j = "clockwise" === c ? b + 1 : b - 1,
                            k = a.outerLabelGroupData[b],
                            l = a.outerLabelGroupData[j],
                            m = {
                        ...
                        if ("clockwise" === c) {
                            for (e = 0; b >= e; e++)
                                if (
                                    ((g = a.outerLabelGroupData[e]),
                                    !i.isLabelHidden(a, e) && f.rectIntersect(g, l))
                                ) {
                                    i.adjustLabelPos(a, j, k, m);
                                    break;
                                }
                        } else
                            for (e = d - 1; e >= b; e--)
            ...
            isLabelHidden: function(a, b) {
                ...
                return (
                    (null !== c && a.options.data.content[b].percentage < c) ||
                    "" === a.options.data.content[b].label
                );
            },
            adjustLabelPos: function(a, b, c, d) {
                ...
                (h = c.y + d.heightChange),
                    (f = d.center.y - h),
                    (e =
                        Math.abs(d.lineLength) > Math.abs(f)
                            ? Math.sqrt(d.lineLength * d.lineLength - f * f)
                            : Math.sqrt(f * f - d.lineLength * d.lineLength)),
                    (g =
                        "right" === c.hs
                            ? d.center.x + e
                            : d.center.x - e - a.outerLabelGroupData[b].w),
            ...
            getIdealOuterLabelPositions: function(a, b) {
                ...
                if (c) {
                    var d = c.getBBox(),
                        e = j.getSegmentAngle(b, a.options.data.content, a.totalSize, {
                            midpoint: !0
                        }),
                        f = a.pieCenter.x,
                        g = a.pieCenter.y - (a.outerRadius + a.options.labels.outer.pieDistance),
                        i = h.rotate(f, g, a.pieCenter.x, a.pieCenter.y, e),
                        k = "right";
                    e > 180 ? ((i.x -= d.width + 8), (k = "left")) : (i.x += 8),
        ...
        j = {
            ...
            create: function(a) {
                var b = a.pieCenter,
                    ...
                    i = f
                        .selectAll("." + a.cssPrefix + "arc")
                        .data(a.options.data.content)
                        .enter()
                        .append("g")
                        .attr("class", a.cssPrefix + "arc"),
                    k = d.speed;
                "none" === d.effect && (k = 0),
                    i
                        .append("path")
                        ...
                        .attr("fill", function(b, d) {
                            var e = c[d];
                            return (
                                a.options.misc.gradient.enabled &&
                                    (e = "url(#" + a.cssPrefix + "grad" + d + ")"),
                                e
                            );
                        })
                        .style("stroke", e)
                        ...
                        .attrTween("d", function(b) {
                            var c = d3.interpolate({ value: 0 }, b);
                            return function(b) {
                                return a.arc(c(b));
                            };
                        }),
                    a.svg.selectAll("g." + a.cssPrefix + "arc").attr("transform", function(b, c) {
                        ...
                        return (
                            c > 0 &&
                                (d = j.getSegmentAngle(c - 1, a.options.data.content, a.totalSize)),
                            "rotate(" + d + ")"
                        );
                    }),
                    (a.arc = g);
            ...
            addGradients: function(a) {
                ...
                b
                    .append("stop")
                    .attr("offset", "0%")
                    .style("stop-color", function(b, c) {
                        return a.options.colors[c];
                    }),
                    b
                        .append("stop")
                        .attr("offset", a.options.misc.gradient.percentage + "%")
                        .style("stop-color", a.options.misc.gradient.color);
            },
            addSegmentEventHandlers: function(a) {
                ...
                b.on("click", function() {
                    ...
                    j.onSegmentEvent(a, a.options.callbacks.onClickSegment, b, e),
                        "none" !== a.options.effects.pullOutSegmentOnClick.effect &&
                            (e ? j.closeSegment(a, b.node()) : j.openSegment(a, b.node()));
                }),
                    b.on("mouseover", function() {
                        ...
                        a.options.tooltips.enabled &&
                            ((c = b.attr("data-index")), l.showTooltip(a, c));
                    ...
                    b.on("mouseout", function() {
                        ...
                        if (
                            ...
                            var e = a.options.colors[c];
                            a.options.misc.gradient.enabled &&
                                (e = "url(#" + a.cssPrefix + "grad" + c + ")"),
                                b.style("fill", e);
                        }
                        a.options.tooltips.enabled &&
                            ((c = b.attr("data-index")), l.hideTooltip(a, c));
            ...
            openSegment: function(a, b) {
                a.isOpeningSegment ||
                    ((a.isOpeningSegment = !0),
                    j.maybeCloseOpenSegment(a),
                    d3
                        .select(b)
                        .transition()
                        .ease(j.effectMap[a.options.effects.pullOutSegmentOnClick.effect])
                        .duration(a.options.effects.pullOutSegmentOnClick.speed)
            ...
            maybeCloseOpenSegment: function(a) {
                d3.selectAll("." + a.cssPrefix + "expanded").size() > 0 &&
                    j.closeSegment(a, d3.select("." + a.cssPrefix + "expanded").node());
            },
        ...
        k = {
            ...
            addTitle: function(a) {
                a.svg
                    .selectAll("." + a.cssPrefix + "title")
                    .data([a.options.header.title])
                    .enter()
                    .append("text")
                    .text(function(a) {
                        return a.text;
                    })
                    .attr("id", a.cssPrefix + "title")
                    .attr("class", a.cssPrefix + "title")
                    .attr("x", k.offscreenCoord)
                    .attr("y", k.offscreenCoord)
                    .attr("text-anchor", function() {
                        var b;
                        return (b =
                            "top-center" === a.options.header.location ||
                            "pie-center" === a.options.header.location
                                ? "middle"
                                : "left");
                    })
            ...
            addSubtitle: function(a) {
                ...
                a.svg
                    .selectAll("." + a.cssPrefix + "subtitle")
                    .data([a.options.header.subtitle])
                    .enter()
                    .append("text")
                    .text(function(a) {
                        return a.text;
                    ...
                    .attr("x", k.offscreenCoord)
                    .attr("y", k.offscreenCoord)
                    .attr("id", a.cssPrefix + "subtitle")
                    .attr("class", a.cssPrefix + "subtitle")
                    .attr("text-anchor", function() {
                        var a;
            ...
            positionSubtitle: function(a) {
                ...
                (b =
                    "top-left" === a.options.header.location ? c.left : (d - c.right) / 2 + c.left),
                    (b += a.options.misc.pieCenterOffset.x);
                var e = k.getHeaderHeight(a);
                a.svg
                    .select("#" + a.cssPrefix + "subtitle")
                    .attr("x", b)
                    .attr("y", e);
            },
            addFooter: function(a) {
                a.svg
                    .selectAll("." + a.cssPrefix + "footer")
                    .data([a.options.footer])
                    .enter()
                    .append("text")
                    .text(function(a) {
                        return a.text;
                    ...
                    .attr("x", k.offscreenCoord)
                    .attr("y", k.offscreenCoord)
                    .attr("id", a.cssPrefix + "footer")
                    .attr("class", a.cssPrefix + "footer")
                    .attr("text-anchor", function() {
                        var b = "left";
                        return (
                            "bottom-center" === a.options.footer.location
                                ? (b = "middle")
                                : "bottom-right" === a.options.footer.location && (b = "left"),
                            b
                        );
                    })
                    .attr("fill", function(a) {
            ...
            getHeaderHeight: function(a) {
                ...
                if (a.textComponents.title.exists) {
                    ...
                    b =
                        "pie-center" === a.options.header.location
                            ? a.pieCenter.y - c / 2 + c
                            : c + a.options.misc.canvasPadding.top;
                } else if ("pie-center" === a.options.header.location) {
                    var d = a.options.misc.canvasPadding.bottom + a.textComponents.footer.h;
                    b =
                        (a.options.size.canvasHeight - d) / 2 +
                        a.options.misc.canvasPadding.top +
                        a.textComponents.subtitle.h / 2;
        ...
        l = {
            addTooltips: function(a) {
                ...
                b
                    .selectAll("." + a.cssPrefix + "tooltip")
                    .data(a.options.data.content)
                    .enter()
                    .append("g")
                    .attr("class", a.cssPrefix + "tooltip")
                    .attr("id", function(b, c) {
                        return a.cssPrefix + "tooltip" + c;
                    })
                    .style("opacity", 0)
                    .append("rect")
                    .attr("rx", a.options.tooltips.styles.borderRadius)
                    .attr("ry", a.options.tooltips.styles.borderRadius)
                    .attr("x", -a.options.tooltips.styles.padding)
                    .attr("opacity", a.options.tooltips.styles.backgroundOpacity)
                    .style("fill", a.options.tooltips.styles.backgroundColor),
                    b
                        .selectAll("." + a.cssPrefix + "tooltip")
                        .data(a.options.data.content)
                        .append("text")
                        ...
                        .text(function(b, c) {
                            ...
                            return (
                                "caption" === a.options.tooltips.type && (d = b.caption),
                                l.replacePlaceholders(a, d, c, {
                                    label: b.label,
                                    value: b.value,
                    ...
                    b
                        .selectAll("." + a.cssPrefix + "tooltip rect")
                        .attr("width", function(b, c) {
                            var d = f.getDimensions(a.cssPrefix + "tooltip" + c);
            ...
            showTooltip: function(a, b) {
                ...
                l.currentTooltip === b && (c = 1),
                    (l.currentTooltip = b),
                    d3
                        .select("#" + a.cssPrefix + "tooltip" + b)
                        .transition()
                        .duration(c)
            ...
            moveTooltip: function(a) {
                d3
                    .selectAll("#" + a.cssPrefix + "tooltip" + l.currentTooltip)
            ...
            hideTooltip: function(a, b) {
                d3.select("#" + a.cssPrefix + "tooltip" + b).style("opacity", function() {
                    ...
                    d3
                        .select("#" + a.cssPrefix + "tooltip" + l.currentTooltip)
                        .attr("transform", function(b, c) {
            ...
            replacePlaceholders: function(a, b, c, d) {
                f.isFunction(a.options.tooltips.placeholderParser) &&
                    a.options.tooltips.placeholderParser(c, d);
                var e = function() {
                    return function(a) {
                        var b = arguments[1];
        ...
        m = function(f, h) {
            if (((this.element = f), "string" == typeof f)) {
                var i = f.replace(/^#/, "");
            ...
            g(!0, j, d, h),
                (this.options = j),
                null !== this.options.misc.cssPrefix
                    ? (this.cssPrefix = this.options.misc.cssPrefix)
                    : ((this.cssPrefix = "p" + c + "_"), c++),
                e.initialCheck(this) &&
                    (d3.select(this.element).attr(a, b), n.call(this), o.call(this));
        };
    (m.prototype.recreate = function() {
        e.initialCheck(this) && (n.call(this), o.call(this));
    }),
        ...
        (m.prototype.getOpenSegment = function() {
            var a = this.currentlyOpenSegment;
            if (null !== a && "undefined" != typeof a) {
                var b = parseInt(d3.select(a).attr("data-index"), 10);
                return { element: a, index: b, data: this.options.data.content[b] };
            }
            return null;
        }),
        (m.prototype.openSegment = function(a) {
            (a = parseInt(a, 10)),
                0 > a ||
                    a > this.options.data.content.length - 1 ||
                    j.openSegment(this, d3.select("#" + this.cssPrefix + "segment" + a).node());
        }),
        (m.prototype.closeSegment = function() {
            j.maybeCloseOpenSegment(this);
        }),
        (m.prototype.updateProp = function(a, b) {
            switch (a) {
                ...
                case "effects.highlightLuminosity":
                    ...
                    break;
                default:
                    f.processObj(this.options, a, b), this.destroy(), this.recreate();
            }
        });
    var n = function() {
            (this.options.data.content = h.sortPieData(this)),
                this.options.data.smallSegmentGrouping.enabled &&
                    (this.options.data.content = f.applySmallSegmentGrouping(
                        this.options.data.content,
                        this.options.data.smallSegmentGrouping
                    )),
                (this.options.colors = f.initSegmentColors(this)),
                (this.totalSize = h.getTotalPieSize(this.options.data.content));
            for (
                var a = this.options.labels.percentage.decimalPlaces, b = 0;
                b < this.options.data.content.length;
                b++
            )
                this.options.data.content[b].percentage = p(
                    this.options.data.content[b].value,
                    this.totalSize,
                    a
                );
            for (var c = 0, d = 0; d < this.options.data.content.length; d++)
                d === this.options.data.content.length - 1 &&
                    (this.options.data.content[d].percentage = (100 - c).toFixed(a)),
                    (c += parseFloat(this.options.data.content[d].percentage));
        },
        o = function() {
            (this.svg = f.addSVGSpace(this)),
                (this.textComponents = {
                    headerHeight: 0,
                    title: { exists: "" !== this.options.header.title.text, h: 0, w: 0 },
                    subtitle: { exists: "" !== this.options.header.subtitle.text, h: 0, w: 0 },
                    footer: { exists: "" !== this.options.footer.text, h: 0, w: 0 }
                }),
                (this.outerLabelGroupData = []),
                this.textComponents.title.exists && k.addTitle(this),
                this.textComponents.subtitle.exists && k.addSubtitle(this),
                k.addFooter(this);
            var a = this;
            ...
            this.textComponents.title.exists && b.push(this.cssPrefix + "title"),
                ...
                f.whenElementsExist(b, function() {
                    if (a.textComponents.title.exists) {
                    ...
                    if (a.textComponents.title.exists || a.textComponents.subtitle.exists) {
                        var d = 0;
                        a.textComponents.title.exists &&
                            ((d += a.textComponents.title.h),
                            a.textComponents.subtitle.exists &&
                                (d += a.options.header.titleSubtitlePadding)),
                            a.textComponents.subtitle.exists && (d += a.textComponents.subtitle.h),
                            (a.textComponents.headerHeight = d);
                    }
                    h.computePieRadius(a),
                        h.calculatePieCenter(a),
                        k.positionTitle(a),
                        k.positionSubtitle(a),
                        a.options.misc.gradient.enabled && j.addGradients(a),
                        j.create(a),
                        i.add(a, "inner", a.options.labels.inner.format),
                        i.add(a, "outer", a.options.labels.outer.format),
                        i.positionLabelElements(a, "inner", a.options.labels.inner.format),
                        i.positionLabelElements(a, "outer", a.options.labels.outer.format),
                        i.computeOuterLabelCoords(a),
                        i.positionLabelGroups(a, "outer"),
                        i.computeLabelLinePositions(a),
                        a.options.labels.lines.enabled &&
                            "none" !== a.options.labels.outer.format &&
                            i.addLabelLines(a),
                        i.positionLabelGroups(a, "inner"),
                        i.fadeInLabelsAndLines(a),
                        a.options.tooltips.enabled && l.addTooltips(a),
                        j.addSegmentEventHandlers(a);
                });
        },
        p = function(a, b, c) {
            var d = a / b;
