...
(function(root, factory) {
    ...
    var validate = {
        ...
        initialCheck: function(pie) {
            ...
            if (!helpers.isArray(options.data.content)) {
                console.error(
                    "d3pie error: invalid config structure: missing data.content property."
                );
                return false;
            }
            ...
            for (var i = 0; i < options.data.content.length; i++) {
                ...
                if (options.data.content[i].value <= 0) {
                    console.log(
                        "not valid - should have positive value: ",
    ...
    var math = {
            ...
            if (size.pieOuterRadius !== null) {
                if (/%/.test(size.pieOuterRadius)) {
                    ...
                    if (pie.options.labels.outer.format !== "none") {
                        var pieDistanceSpace =
                            parseInt(pie.options.labels.outer.pieDistance, 10) * 2;
        ...
        calculatePieCenter: function(pie) {
            ...
            var hasTopTitle =
                pie.textComponents.title.exists && pie.options.header.location !== "pie-center";
            var hasTopSubtitle =
                pie.textComponents.subtitle.exists && pie.options.header.location !== "pie-center";

            var headerOffset = pie.options.misc.canvasPadding.top;
            if (hasTopTitle && hasTopSubtitle) {
                headerOffset +=
                    pie.textComponents.title.h +
                    pie.options.header.titleSubtitlePadding +
                    pie.textComponents.subtitle.h;
            } else if (hasTopTitle) {
            ...
            var x =
                (pie.options.size.canvasWidth -
                    pie.options.misc.canvasPadding.left -
                    pie.options.misc.canvasPadding.right) /
                    2 +
                pie.options.misc.canvasPadding.left;
            var y =
                (pie.options.size.canvasHeight - footerOffset - headerOffset) / 2 + headerOffset;
    ...
    var labels = {
                ...
                labelGroup
                    ...
                    .text(function(d, i) {
                        ...
                        if (settings.formatter) {
                            ...
                            d.label.length > settings.truncation.truncateLength
                        ) {
                ...
                labelGroup
                    ...
                    .text(function(d, i) {
                        ...
                        return settings.formatter
                            ? settings.formatter(formatterContext, d.value)
                            : d.value;
                    })
        ...
        positionLabelElements: function(pie, section, sectionDisplayType) {
            ...
            labelGroups.each(function(d, i) {
                var mainLabel = d3
                    .select(this)
                    .selectAll("." + pie.cssPrefix + "segmentMainLabel-" + section);
                var percentage = d3
                    .select(this)
                    .selectAll("." + pie.cssPrefix + "segmentPercentage-" + section);
                var value = d3
                    .select(this)
                    .selectAll("." + pie.cssPrefix + "segmentValue-" + section);
        ...
        computeLinePosition: function(pie, i) {
            ...
            switch (quarter) {
                case 0:
                    ...
                    y2 =
                        pie.outerLabelGroupData[i].y +
                        (originCoords.y - pie.outerLabelGroupData[i].y) / midPoint;
                    x3 = pie.outerLabelGroupData[i].x - labelXMargin;
                    y3 = pie.outerLabelGroupData[i].y - heightOffset;
                    break;
                case 1:
                    x2 =
                        originCoords.x + (pie.outerLabelGroupData[i].x - originCoords.x) / midPoint;
                    y2 =
                        originCoords.y + (pie.outerLabelGroupData[i].y - originCoords.y) / midPoint;
                    x3 = pie.outerLabelGroupData[i].x - labelXMargin;
                    y3 = pie.outerLabelGroupData[i].y - heightOffset;
                    break;
                case 2:
                    var startOfLabelX =
                        pie.outerLabelGroupData[i].x + pie.outerLabelGroupData[i].w + labelXMargin;
        ...
        addLabelLines: function(pie) {
            ...
            lineGroup
                ...
                .attr("stroke", function(d, i) {
                    return pie.options.labels.lines.color === "segment"
                        ? pie.options.colors[i]
                        : pie.options.labels.lines.color;
                })
                .attr("stroke-width", 1)
                .attr("fill", "none")
                .style("opacity", function(d, i) {
                    ...
                    var isHidden =
                        (percentage !== null &&
                            pie.options.data.content[i].percentage < percentage) ||
                        pie.options.data.content[i].label === "";
                    return isHidden ? 0 : 1;
                });
        },
                ...
                .attr("transform", function(d, i) {
                    ...
                    if (section === "outer") {
                        ...
                        if (pie.innerRadius > 0) {
                            var angle = segments.getSegmentAngle(
                                i,
                                pie.options.data.content,
                                pie.totalSize,
                                { midpoint: true }
                            );
                            var newCoords = math.translate(
                                pie.pieCenter.x,
                                pie.pieCenter.y,
                                pie.innerRadius,
                                angle
                        ...
                        var dims = helpers.getDimensions(
                            pie.cssPrefix + "labelGroup" + i + "-inner"
                        );
        ...
        fadeInLabelsAndLines: function(pie) {
            ...
            var loadSpeed =
                pie.options.effects.load.effect === "default" ? pie.options.effects.load.speed : 1;
            setTimeout(function() {
                var labelFadeInTime = pie.options.effects.load.effect === "default" ? 400 : 1; // 400 is hardcoded for the present

                d3
                    .selectAll("." + pie.cssPrefix + "labelGroup-outer")
                    .transition()
                ...
                d3
                    .selectAll("." + pie.cssPrefix + "labelGroup-inner")
                    .transition()
                    .duration(labelFadeInTime)
                    .style("opacity", function(d, i) {
                ...
                d3
                    .selectAll("g." + pie.cssPrefix + "lineGroups")
                    .transition()
                    .duration(labelFadeInTime)
                    .style("opacity", 1);
        ...
        checkConflict: function(pie, currIndex, direction, size) {
            ...
            if (direction === "clockwise") {
                ...
                for (; i <= currIndex; i++) {
                    ...
                    if (
                        !labels.isLabelHidden(pie, i) &&
                        helpers.rectIntersect(curr, examinedLabelGroup)
                    ) {
        ...
        isLabelHidden: function(pie, index) {
            var percentage = pie.options.labels.outer.hideWhenLessThanPercentage;
            return (
                (percentage !== null && pie.options.data.content[index].percentage < percentage) ||
                pie.options.data.content[index].label === ""
            );
        },
        ...
        getIdealOuterLabelPositions: function(pie, i) {
            var labelGroupNode = d3
                .select("#" + pie.cssPrefix + "labelGroup" + i + "-outer")
                .node();
            if (!labelGroupNode) {
                return;
            }
            ...
            var originalY =
                pie.pieCenter.y - (pie.outerRadius + pie.options.labels.outer.pieDistance);
            var newCoords = math.rotate(
                originalX,
                originalY,
                pie.pieCenter.x,
                pie.pieCenter.y,
    ...
    var segments = {
        ...
        create: function(pie) {
            ...
            pie.svg.selectAll("g." + pie.cssPrefix + "arc").attr("transform", function(d, i) {
                var angle = 0;
                if (i > 0) {
                    angle = segments.getSegmentAngle(
                        i - 1,
                        pie.options.data.content,
                        pie.totalSize
                    );
        ...
        addSegmentEventHandlers: function(pie) {
            ...
            arc.on("click", function() {
                ...
                segments.onSegmentEvent(
                    pie,
                    pie.options.callbacks.onClickSegment,
                    segment,
                    isExpanded
                );
            ...
            arc.on("mouseover", function() {
                ...
                segments.onSegmentEvent(
                    pie,
                    pie.options.callbacks.onMouseoverSegment,
                    segment,
                    isExpanded
                );
            });
            ...
            arc.on("mouseout", function() {
                ...
                segments.onSegmentEvent(
                    pie,
                    pie.options.callbacks.onMouseoutSegment,
                    segment,
                    isExpanded
                );
            });
    ...
    var text = {
        ...
        addTitle: function(pie) {
            var title = pie.svg
                ...
                .attr("text-anchor", function() {
                    var location;
                    if (
                        pie.options.header.location === "top-center" ||
                        pie.options.header.location === "pie-center"
                    ) {
                        location = "middle";
                    } else {
                        location = "left";
            ...
            if (headerLocation === "pie-center") {
                ...
                if (textComponents.subtitle.exists) {
                    var totalTitleHeight =
                        textComponents.title.h + titleSubtitlePadding + textComponents.subtitle.h;
        ...
        getHeaderHeight: function(pie) {
            ...
            if (pie.textComponents.title.exists) {
                ...
                if (pie.options.header.location === "pie-center") {
                    var footerPlusPadding =
                        pie.options.misc.canvasPadding.bottom + pie.textComponents.footer.h;
                    h =
    ...
    var tt = {
        addTooltips: function(pie) {
            ...
            tooltips
                .selectAll("." + pie.cssPrefix + "tooltip rect")
        ...
        moveTooltip: function(pie) {
            d3
                .selectAll("#" + pie.cssPrefix + "tooltip" + tt.currentTooltip)
        ...
        hideTooltip: function(pie, index) {
            ...
            d3
                .select("#" + pie.cssPrefix + "tooltip" + tt.currentTooltip)
                .attr("transform", function(d, i) {
    ...
    var _setupData = function() {
        ...
        for (var i = 0; i < this.options.data.content.length; i++) {
            this.options.data.content[i].percentage = _getPercentage(
                this.options.data.content[i].value,
                this.totalSize,
                dp
            );
        }
