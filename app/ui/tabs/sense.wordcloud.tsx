...
export function getSenseWordcloud(iri: string) {
    return withLoading(SenseWordcloud, "spinner", DataLoader.loadSenseWordcloud, [iri]);
}

export interface ISenseWordcloudProps {
    iri: string;
    data: ITermWeighted[];
}

export class SenseWordcloud extends React.Component<ISenseWordcloudProps> {
    render(): JSX.Element {
